...
const Education = () => {
  const educationData = [
    ...
    },
    {
      ...
      institution: "Vartak College of Science",
      year: "2021",
      score: 95,
    ...
    },
    {
      ...
      institution: "Purushottam Vidhyalaya",
      year: "2019",
      score: 89.40,
      scoreLabel: "Percentage",
      location: "Nalasopara, Palghar, Maharashtra",
      icon: BookOpen,
      courses: [
        "Mathematics",
        "Science",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#090517] to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {/* Entrance Exams Section - Now Second */}
        <div>
          <h3 className="text-3xl font-bold text-white mb-8 pl-4 border-l-4 border-[#4F46E5] animate-fade-in">
            Entrance Examinations
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {entranceData.map((entrance, index) => (
              <EntranceCard
                key={index}
                {...entrance}
              />
