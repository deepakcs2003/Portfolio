        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="animate-fade-in text-center lg:text-left relative">
            ...
            <div className="flex items-center justify-center lg:justify-start space-x-6 mt-8">
              {[
                { platform: 'linkedin', url: 'https://www.linkedin.com/in/deepakv2003' },
                { platform: 'github', url: 'https://github.com/deepakcs2003' },
                { platform: 'globe', url: 'https://deep-shop.vercel.app' }
            ...
            <div className="relative">
              <div className="sticky top-8">
                ...
                <div className="space-y-6">
                  {[
                    { icon: Phone, text: '7709894512', href: 'tel:7709894512' },
                    { icon: Mail, text: 'guddi7709894512@gmail.com', href: 'mailto:guddi7709894512@gmail.com' },
                    { icon: MapPin, text: 'Mumbai, Maharastra, Malad' }
                  ].map((item, index) => (
                    <a
                      key={index}
                      href={item.href}
