...
const Coding = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const endpoints = {
        leetcode: {
          url: 'https://alfa-leetcode-api.onrender.com/userProfile/deepak_v2003',
          options: { method: 'GET' }
        },
        codechef: {
          url: 'https://codechef-api.vercel.app/handle/deepak_v2003',
          options: { method: 'GET' }
        },
        geeksforgeeks: {
          url: `https://api.allorigins.win/get?url=${encodeURIComponent('https://geeks-for-geeks-api.vercel.app/deepak_cse')}`,
          options: { method: 'GET' }
        },
        codeforces: {
          url: `https://api.allorigins.win/get?url=${encodeURIComponent('https://codeforces.com/api/user.info?handles=deepak_v2003')}`,
          options: { method: 'GET' }
        }
      };
